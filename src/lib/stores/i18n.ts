...
export const translations: Record<Language, TranslationObject> = {
	en: {
		...
		courseDescription2:
			"Experience Sandviken's most beautiful landscapes in a single day as you challenge yourself on our meticulously designed route featuring lakeside views, forest trails, and historic landmarks.",
		iaafCertified:
			'Our IAAF-certified marathon route takes you through the most scenic parts of Sandviken, offering a perfect balance of challenge and beauty.',
		routeHighlights: 'Route Highlights',
		lakesideStart: 'Lakeside Start (0-10km)',
		lakesideStartText:
			"Begin your journey with breathtaking views of Lake Storsjön's crystal waters.",
		...
		victoryBoulevardText:
			'The final stretch through downtown with cheering crowds leading to the finish.',
		...
		aidStationsFeatureText:
			'8 fully-equipped stations with hydration, nutrition, and medical support',
		...
		startFinishAreaText:
			'The start and finish are located in central Sandviken, at Stadsparken. Bessemerhallen provides changing rooms, restrooms, and the Expo (bib number pickup). Parking is available at Bessemerskolan, Parkbadet, Lidl, and Ica Maxi.',
		raceExpo: 'Race Expo',
		...
		earlyBirdPromo:
			"Early bird registration opens soon with exclusive benefits for founding participants. Don't miss your chance to be part of history.",
		...
		routeDescription:
			"Run through vibrant townscapes reflecting Sandviken's steel-making legacy, along the shores of Lake Storsjön, and past significant local landmarks",
		...
		joinUs:
			"Join us for the inaugural Sandviken Marathon and become one of our founding participants. This is your chance to make history in Sandviken's first major marathon event.",
		...
		aboutIntro:
			"Welcome to the Sandviken Marathon, a premier running event in the heart of Gästrikland. Discover a course that winds through Sandviken's dynamic industrial history and its breathtaking natural surroundings.",
		aboutMission: 'Our Mission',
		aboutMissionSubtitle: 'Our core purpose and values',
		aboutMissionText1:
			'The Sandviken Marathon is dedicated to creating an inclusive and electrifying race day for all. We aim to fuse the spirit of our historic town with the pursuit of personal achievement, promoting health, community, and the enduring strength found in both our heritage and our runners.',
		...
		aboutHistoryDesc:
			'The Sandviken Marathon was established in 2023 with a vision to bring the community together through the power of running.',
		aboutValuesTitle: 'Our Values',
		aboutValuesDesc:
			'We believe in promoting health, fitness, and community spirit through the joy of running.',
		aboutCommunityTitle: 'Our Community',
		aboutCommunityDesc:
			'The Sandviken Marathon brings together runners, volunteers, and spectators from all walks of life.',
		aboutFutureTitle: 'Our Future',
		aboutFutureDesc:
			'We are committed to growing the Sandviken Marathon while maintaining its community spirit and commitment to excellence.',
		eventDetailsTitle: 'Event Details',
		eventDetailsSubtitle: 'Everything you need to know about our event',
		eventDetailsDesc:
			'The marathon starts and finishes at Stadsparken (City Park) in central Sandviken, offering a beautiful route through walking paths and lesser-traveled roads with water stations every 5km.',
		...
		coursePageIntro:
			'Explore the scenic route through Sandviken and its beautiful surroundings. Our marathon course takes you through the heart of the city and along picturesque landscapes with water stations every 5km.',
		...
		surfaceDesc:
			'Mixed surfaces including walking paths (60%), minor roads (30%), and urban areas (10%).',
		...
		registrationInfo:
			'Registration will be available through our official registration platform. Stay tuned!',
		...
		courseDescription:
			'This race covers the full marathon distance and showcases some of the most beautiful parts of Sandviken. Most of the course runs along pedestrian paths and smaller roads. Water stations are placed every 5 kilometers.\n\nThe start and finish are located in central Sandviken, at Stadsparken. The race begins with a stretch heading toward Stora COOP and ÅB, continues past BJ Arena, down to Säljan, and alongside the Trebo golf course. From there, the route follows the pedestrian path next to the Trebo lighted trail before reaching Bångs, which is especially beautiful if the weather allows.\n\nSo far, the course has mostly followed pedestrian paths. After passing Bångs, the route continues along the road toward Bovik — a somewhat less exciting section of the course, with a lot of forest but relatively flat terrain and light traffic.\n\nAs you approach Bovik by Lake Storsjön, the landscape opens up again, offering a particularly scenic part of the course. The race continues through a lakeside cottage area before reaching Forsbacka, another beautiful waterfront location. Here, you\'ll encounter one of the more traffic-heavy sections of the course: the road between Forsbacka and Lövbacken.\n\nAfter the "Norra infarten" roundabout, participants will pass Sandvik/Cormant and run through the Klangberget residential area. The course then heads down across Högbovägen, passing the stables.\n\nFinally, runners enter the scenic Gästrikeleden/Hälsans stig trail, which leads all the way back to Stadsparken.',
		...
		raceDayDetails:
			'Stadsparken is the central hub for all race activities. Bessemerhallen offers changing rooms, restrooms, and bib number pickup (Expo). The playground is a dedicated area for children, featuring face painting, a bouncy castle, the Sandviken Little Race, and the SGA Obstacle Course. Drömfabriken organizes the Sandviken Funkis Race. Parking is available at Bessemerskolan, Parkbadet, Lidl, and Ica Maxi. The finish area includes food trucks, sponsor/exhibitor booths, ice cream, drinks, and massage services.',
		...
		medicalStationDetails:
			'Medical support and first aid available at designated stations throughout the course',
		...
		privacyIntroText:
			'Sandviken Marathon ("we," "our," or "us") respects your privacy and is committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights.',
		privacyHighlight:
			'This document explains how we collect, use, and protect your personal information. By using our website, you agree to the terms outlined in this policy.',
		...
		termsIntro:
			'Please read our terms and conditions before using our website or registering for events',

		// Terms Overview section
		agreementToTerms: 'Agreement to Terms',
		termsAgreementText:
			'These Terms and Conditions constitute a legally binding agreement made between you and Sandviken Marathon concerning your use of our website and participation in our events. By using our website or registering for our events, you agree to be bound by these Terms.',
		termsReviewText:
			'Please review these terms carefully. By accessing this website or registering for our events, you acknowledge that you have read, understood, and agree to be bound by all of these Terms and Conditions.',

		// Event Registration section
		eventRegistration: 'Event Registration',
		registrationText:
			'When you register for an event organized by Sandviken Marathon, you agree to the following terms:',
		physicalFitness: 'Physical Fitness',
		physicalFitnessText:
			'You confirm that you are physically fit and have no medical conditions that would make participation in the event dangerous to your health.',
		riskAcceptance: 'Risk Acceptance',
		riskAcceptanceText:
			'You understand and acknowledge that participation in running events involves inherent risks and dangers of accidents, personal injury, and property loss or damage.',
		nonRefundableFees: 'Non-Refundable Fees',
		nonRefundableFeesText:
			'Registration fees are non-refundable, except in specific circumstances as outlined in our Refund Policy.',
		scheduleChanges: 'Schedule Changes',
		scheduleChangesText:
			'Organizers reserve the right to modify, cancel or postpone the event due to unforeseen circumstances. In such cases, our Cancellation Policy will apply.',
		ruleCompliance: 'Rule Compliance',
		ruleComplianceText:
			'You agree to comply with all event rules, regulations, and instructions provided by event organizers and staff.',
		...
		ipText:
			'The Sandviken Marathon website and its original content, features, and functionality are owned by Sandviken Marathon and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.',
		copyrightTitle: 'Copyright',
		copyrightTextContent:
			'All content, including but not limited to text, images, graphics, logos, and video clips, is the property of Sandviken Marathon and is protected by copyright laws.',
		limitedLicenseTitle: 'Limited License',
		limitedLicenseTextContent:
			'We grant you a limited, non-exclusive, non-transferable, and revocable license to access and use our website for personal, non-commercial purposes.',
		restrictions: 'Restrictions',
		restrictionsText:
			'You may not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any content on our website without our express written permission.',
		ipConclusion:
			'Any unauthorized use of the material on this website may violate copyright, trademark, and other applicable laws and could result in criminal or civil penalties.',

		// User Conduct section
		userConduct: 'User Conduct',
		userConductIntro:
			'When using our website and participating in our events, you agree to conduct yourself appropriately.',
		userConductText:
			'As a user of our website and participant in our events, you agree not to engage in any of the following prohibited activities:',
		conductRule1:
			'Using the website in any way that violates any applicable local, national, or international law or regulation.',
		conductRule2:
		...
		conductRule3:
			"Engaging in any conduct that restricts or inhibits anyone's use or enjoyment of the website, or which may harm Sandviken Marathon or users of the website.",
		conductRule4:
			'Uploading or transmitting viruses, malware, or other types of malicious code that will or may impact the functionality of the website.',

		// Limitation of Liability section
		limitationOfLiability: 'Limitation of Liability',
		liabilityIntro:
			'Understanding our liability limitations is important for all participants and website users',
		liabilityText:
			'To the maximum extent permitted by law, Sandviken Marathon and its affiliates shall not be liable for:',
		liabilityItem1:
			'Any injuries, losses, or damages of any kind arising from participation in our events',
		liabilityItem2:
			'Any indirect, consequential, exemplary, incidental, special, or punitive damages, including lost profits',
		liabilityItem3:
			'Any issues related to the accuracy, reliability, timeliness, or performance of the website',
		liabilityItem4:
			'Any viruses, malware, or other malicious code that may be transmitted to or through the website',
		...
		modificationsText:
			'Sandviken Marathon reserves the right to modify these Terms and Conditions at any time. When we make changes:',
		...
		modificationPoint2:
			'Any changes will be effective immediately upon posting the updated terms on this website',
		modificationAcceptance: 'Acceptance',
		modificationPoint3:
			'Your continued use of the website and/or participation in our events after we post changes to these terms means that you accept the revised terms',
		modificationDisclaimer:
			'It is your responsibility to periodically check this page for any changes to the Terms and Conditions',
		...
		informationCollectedText:
			'We collect personal data when you register for our events or use our website:',
		...
		paymentInfoText:
			'Card details when you make a purchase (processed securely by our payment provider).',
		...
		contactCardText:
			'To communicate with you about the event, your registration, and any important updates.',
		...
		aboutHistoryNationalRecognitionText:
		...
		eventDetailsLocationText:
			'The race takes place in the beautiful city of Sandviken, featuring scenic routes through parks and along the waterfront.',
		...
		introText:
			"Experience Sweden's premier running event — where Sandviken's rich industrial heart meets the wild spirit of Gästrikland's forests and lakes.",
		inauguralEventTitle: 'INAUGURAL EVENT • 2026',
		bePartOfHistory: 'Be Part of <span class="text-red-600">Running History</span>',
		inauguralDescription:
			"The Sandviken Marathon isn't just a race—it's a landmark moment for our town and Sweden's running community. Join us as we forge a new tradition in a place renowned for innovation and endurance, establishing a prestigious Scandinavian running event.",
		...
		eventRulesText: 'Detailed rules and regulations will be provided closer to the event date.',
		volunteerSection: 'Volunteer Information',
		volunteerText:
			'Interested in volunteering? We need help with various tasks. Sign up via the contact form.',
		riskManagementTitle: 'Risk Management and Safety',
		riskManagementDesc:
			'Risk: Unexpected weather conditions, Participant health issues, Traffic safety, Logistics and organization, Security and safety measures. Action: Weather contingency plan, medical staff and first aid, properly cordoned-off course with traffic marshals, detailed logistics plan, cooperation with authorities and security companies.',
		staffingPlanTitle: 'Event Staff and Support',
		staffingPlanDesc:
			'Officials will be on site to assist with participant registration, distribution of bib numbers and race kits, providing guidance and information, monitoring the course, managing water stations, and assisting at start/finish areas. Medical personnel will be available throughout the event to provide first aid, monitor health, respond to emergencies, and will be stationed strategically along the course and at start/finish areas during event hours. Security officers will ensure safety and order, monitor spectator areas, manage security incidents, and ensure the course is properly cordoned off.',
		stadsparkenMapAlt:
			'Map of Stadsparken showing key areas for the Sandviken Marathon, including start/finish, expo, and amenities.',

		// Cookie Consent
		cookieNoticeText:
			'This website uses <a href="/privacy#cookies" class="underline hover:text-red-600">cookies</a> to ensure you get the best experience. By continuing to browse, you agree to our use of cookies.'
	},
	sv: {
		// Navigation section tabs
		...
		raceVillageOpensText:
			'Tävlingsområdet öppnar med registrering, nummerlappsutdelning och utställare',
		warmupSession: '7:30',
		...
		courseDescription2:
			'Upplev Sandvikens vackraste landskap på en enda dag när du utmanar dig själv på vår noggrant utformade bana med utsikt över sjöar, skogsstigar och historiska landmärken.',
		iaafCertified:
			'Vår IAAF-certifierade maratonbana tar dig genom de mest natursköna delarna av Sandviken och erbjuder en perfekt balans mellan utmaning och skönhet.',
		...
		victoryBoulevardText:
			'Den sista sträckan genom centrala staden med jublande folkmassa som leder till målet.',
		...
		startFinishAreaText:
			'Start och mål är belägna i centrala Sandviken, vid Stadsparken. Bessemerhallen erbjuder omklädningsrum, toaletter och Expo (nummerlappsutdelning). Parkering finns vid Bessemerskolan, Parkbadet, Lidl och Ica Maxi.',
		...
		earlyBirdPromo:
			'Early bird-registrering öppnar snart med exklusiva förmåner för grundande deltagare. Missa inte din chans att bli en del av historien.',
		...
		routeDescription:
			'Spring genom levande stadsbilder som speglar Sandvikens stålindustriarv, längs Storsjöns stränder och förbi betydelsefulla lokala landmärken',
		...
		joinUs:
			'Gå med oss för det första Sandviken Marathon och bli en av våra grundande deltagare. Detta är din chans att göra historia i Sandvikens första stora maraton.',
		...
		aboutIntro:
			'Välkommen till Sandviken Marathon, ett förstklassigt löparevenemang i hjärtat av Gästrikland. Upptäck en bana som slingrar sig genom Sandvikens dynamiska industrihistoria och dess hänförande naturomgivningar.',
		aboutMission: 'Vårt Uppdrag',
		aboutMissionSubtitle: 'Vårt kärnsyfte och våra värderingar',
		aboutMissionText1:
			'Sandviken Marathon är dedikerat till att skapa en inkluderande och elektrifierande loppdag för alla. Vi strävar efter att förena andan i vår historiska stad med strävan efter personlig prestation, och främja hälsa, gemenskap och den bestående styrka som finns i både vårt arv och våra löpare.',
		aboutMissionHighlight:
		...
		aboutHistoryDesc:
			'Sandviken Marathon grundades 2023 med en vision att föra samman gemenskapen genom löpandets kraft.',
		aboutValuesTitle: 'Våra Värderingar',
		aboutValuesDesc:
			'Vi tror på att främja hälsa, fitness och gemenskapens anda genom löpandets glädje.',
		aboutCommunityTitle: 'Vår Gemenskap',
		aboutCommunityDesc:
			'Sandviken Marathon förenar löpare, volontärer och åskådare från alla samhällsskikt.',
		aboutFutureTitle: 'Vår Framtid',
		aboutFutureDesc:
			'Vi är engagerade i att utveckla Sandviken Marathon samtidigt som vi behåller dess gemenskapssinne och engagemang för excellens.',
		eventDetailsTitle: 'Evenemangsdetaljer',
		eventDetailsSubtitle: 'Everything you need to know about our event',
		eventDetailsDesc:
			'Maratonet startar och avslutas vid Stadsparken i centrala Sandviken, och erbjuder en vacker bana på gångbanor och mindre vägar med vätskestationer var 5:e kilometer.',
		...
		coursePageIntro:
			'Utforska den natursköna rutten genom Sandviken och dess vackra omgivningar. Vår maratonbana tar dig genom hjärtat av staden och längs pittoreska landskap med vätskestationer var 5:e kilometer.',
		...
		surfaceDesc:
			'Blandade underlag inklusive gångbanor (60%), mindre vägar (30%) och stadsområden (10%).',
		...
		registrationInfo:
			'Anmälan kommer att vara tillgänglig via vår officiella anmälningsplattform. Håll utkik!',
		...
		// Course page additional keys
		courseDescription:
			'Detta lopp sträcker sig över Marathon-distansen och visar upp några av de vackraste delarna av Sandviken. Större delen av banan går på gångbanor och mindre vägar. Vätskestationer är placerade var 5:e kilometer.\nStarten och målet är belägna i centrala Sandviken, vid Stadsparken. Loppet inleds med en sträcka upp mot Stora COOP och ÅB, fortsätter förbi BJ Arena, ned mot Säljan och längs Trebo golfbana. Därefter följer vi gångbanan bredvid Trebo elljusspår innan vi når Bångs som är mycket vackert om vädret tillåter.\nHittills har banan mestadels gått på gångbanor. Vi passerar Bångs och fortsätter längs vägen mot Bovik, en lite tråkigare del av banan med mycket skog men relativt platt terräng och låg trafikmängd.\nNär man närmar sig Bovik vid Storsjön öppnar landskapet upp igen, vilket utgör en särskilt naturskön del av banan. Loppet fortsätter genom ett stugområde längs vattnet innan vi når Forsbacka, även detta ett vackert område vid vattnet. Här återfinns en av banans mer trafikintensiva delar, vägen mellan Forsbacka och Lövbacken.\nEfter rondellen "Norra infarten" får deltagarna se Sandvik/Cormant och springa genom Klangberget i villaområdet. Därefter går loppet ned över Högbovägen förbi stallet.\nSlutligen beger sig löparna in på den natursköna Gästrikeleden/Hälsans stig hela vägen tillbaka till Stadsparken.',
		...
		aidStationDetails: 'Vattenstationer är placerade var 5:e kilometer längs banan.',
		...
		raceDayDetails:
			'Stadsparken är centrum för tävlingsaktiviteter. Bessemerhallen erbjuder omklädningsrum, toaletter och nummerlappsutdelning (Expo). Lekparken är barnens område med ansiktsmålning, hoppborg, Sandviken Lilla Loppet och SGA Hinderbana. Drömfabriken anordnar Sandviken Funkis Loppet. Parkering finns vid Bessemerskolan, Parkbadet, Lidl och Ica Maxi. Målområdet har foodtrucks, reklam/sponsringsbås, glass, dryck och massage.',
		...
		medicalStationDetails:
			'Medicinsk support och första hjälp finns tillgängligt vid utsedda stationer längs banan',
		...
		privacyIntroText:
			'Sandviken Marathon ("vi", "vår", "oss") respekterar din integritet och är fast beslutna att skydda dina personuppgifter. Denna integritetspolicy informerar dig om hur vi hanterar dina personuppgifter när du besöker vår webbplats och berättar om dina integritetsrättigheter.',
		privacyHighlight:
			'Detta dokument förklarar hur vi samlar in, använder och skyddar din personliga information. Genom att använda vår webbplats godkänner du villkoren som beskrivs i denna policy.',
		...
		websiteImprovementText:
			'För att förbättra vår webbplats och tjänster baserat på användarupplevelse',
		...
		cookiesSectionTitle: 'Cookies',
		cookiesSectionText:
			'Vår webbplats använder cookies för att förbättra din upplevelse och tillhandahålla vissa funktioner.',
		...
		termsIntro:
			'Vänligen läs våra användarvillkor innan du använder vår webbplats eller registrerar dig för evenemang',

		// Terms Overview section
		agreementToTerms: 'Godkännande av villkor',
		termsAgreementText:
			'Dessa användarvillkor utgör ett juridiskt bindande avtal mellan dig och Sandviken Marathon gällande din användning av vår webbplats och deltagande i våra evenemang. Genom att använda vår webbplats eller registrera dig för våra evenemang godkänner du att vara bunden av dessa villkor.',
		termsReviewText:
			'Vänligen granska dessa villkor noggrant. Genom att besöka denna webbplats eller registrera dig för våra evenemang bekräftar du att du har läst, förstått och samtycker till att vara bunden av alla dessa användarvillkor.',

		// Event Registration section
		eventRegistration: 'Evenemangsregistrering',
		registrationText:
			'När du registrerar dig för ett evenemang som anordnas av Sandviken Marathon godkänner du följande villkor:',
		physicalFitness: 'Fysisk kondition',
		physicalFitnessText:
			'Du bekräftar att du är fysiskt frisk och inte har några medicinska tillstånd som skulle göra deltagande i evenemanget farligt för din hälsa.',
		riskAcceptance: 'Riskacceptans',
		riskAcceptanceText:
			'Du förstår och erkänner att deltagande i löpevenemang innebär inneboende risker och faror för olyckor, personskador och förlust eller skada på egendom.',
		nonRefundableFees: 'Icke återbetalningsbara avgifter',
		nonRefundableFeesText:
			'Registreringsavgifter återbetalas inte, förutom under specifika omständigheter som beskrivs i vår återbetalningspolicy.',
		scheduleChanges: 'Schemaändringar',
		scheduleChangesText:
			'Arrangörerna förbehåller sig rätten att ändra, avbryta eller skjuta upp evenemanget på grund av oförutsedda omständigheter. I sådana fall gäller vår avbokningspolicy.',
		ruleCompliance: 'Regelefterlevnad',
		ruleComplianceText:
			'Du samtycker till att följa alla evenemangsregler, förordningar och instruktioner från evenemangsarrangörer och personal.',

		// Intellectual Property section
		intellectualProperty: 'Immateriella rättigheter',
		ipIntro:
			'Allt innehåll på vår webbplats skyddas av upphovsrätt och andra immaterialrättsliga lagar',
		ipText:
			'Sandviken Marathons webbplats och dess originalinnehåll, funktioner och funktionalitet ägs av Sandviken Marathon och skyddas av internationell upphovsrätt, varumärke, patent, affärshemlighet och andra immaterialrättsliga lagar.',
		copyrightTitle: 'Upphovsrätt',
		copyrightTextContent:
			'Allt innehåll, inklusive men inte begränsat till text, bilder, grafik, logotyper och videoklipp, är Sandviken Marathons egendom och skyddas av upphovsrättslagar.',
		limitedLicenseTitle: 'Begränsad licens',
		limitedLicenseTextContent:
			'Vi beviljar dig en begränsad, icke-exklusiv, icke-överförbar och återkallelig licens att komma åt och använda vår webbplats för personliga, icke-kommersiella ändamål.',
		restrictions: 'Begränsningar',
		restrictionsText:
			'Du får inte reproducera, distribuera, modifiera, skapa härledda verk av, offentligt visa, offentligt utföra, publicera på nytt, ladda ner, lagra eller överföra något innehåll på vår webbplats utan vårt uttryckliga skriftliga tillstånd.',
		ipConclusion:
			'All obehörig användning av materialet på denna webbplats kan bryta mot upphovsrätt, varumärke och andra tillämpliga lagar och kan leda till straffrättsliga eller civilrättsliga påföljder.',

		// User Conduct section
		userConduct: 'Användaruppförande',
		userConductIntro:
			'När du använder vår webbplats och deltar i våra evenemang samtycker du till att uppföra dig korrekt',
		userConductText:
			'Som användare av vår webbplats och deltagare i våra evenemang samtycker du till att inte delta i någon av följande förbjudna aktiviteter:',
		conductRule1:
			'Använda webbplatsen på något sätt som bryter mot tillämpliga lokala, nationella eller internationella lagar eller förordningar',
		conductRule2:
			'Försöka störa, äventyra systemets integritet eller säkerhet, eller avkoda eventuella överföringar till eller från de servrar som driver webbplatsen',
		conductRule3:
			'Engagera sig i något uppförande som begränsar eller hämmar någons användning eller njutning av webbplatsen, eller som kan skada Sandviken Marathon eller användare av webbplatsen',
		conductRule4:
			'Ladda upp eller överföra virus, malware, eller andra typer av skadlig kod som kommer eller kan påverka webbplatsens funktion',

		// Limitation of Liability section
		limitationOfLiability: 'Ansvarsbegränsning',
		liabilityIntro:
			'Att förstå våra ansvarsbegränsningar är viktigt för alla deltagare och webbplatsanvändare',
		liabilityText:
			'I den utsträckning som är tillåten enligt lag, är Sandviken Marathon och dess dotterbolag inte ansvariga för:',
		liabilityItem1:
			'Några skador, förluster eller skador av något slag som uppstår från deltagande i våra evenemang',
		liabilityItem2:
			'Några indirekta, följdmässiga, exemplariska, tillfälliga, speciella eller straffskadestånd, inklusive förlorade vinster',
		liabilityItem3:
			'Eventuella problem relaterade till webbplatsens noggrannhet, tillförlitlighet, aktualitet eller prestanda',
		liabilityItem4:
			'Eventuella virus, malware, eller annan skadlig kod som kan överföras till eller genom webbplatsen',
		liabilityItem5:
			'Innehåll på eventuella tredjepartswebbplatser som är länkade till vår webbplats',

		// Modifications section
		modifications: 'Ändringar av villkor',
		modificationsIntro: 'Vi kan uppdatera våra användarvillkor från tid till annan',
		modificationsText:
			'Sandviken Marathon förbehåller sig rätten att ändra dessa användarvillkor när som helst. När vi gör ändringar:',
		modificationNotice: 'Meddelande',
		modificationPoint1:
			'Vi kommer att uppdatera datumet för "senast uppdaterad" överst på denna sida',
		modificationEffect: 'Effekt',
		modificationPoint2:
			'Alla ändringar träder i kraft omedelbart efter att de uppdaterade villkoren har publicerats på denna webbplats',
		modificationAcceptance: 'Godkännande',
		modificationPoint3:
			'Din fortsatta användning av webbplatsen och/eller deltagande i våra evenemang efter att vi publicerar ändringar av dessa villkor innebär att du accepterar de reviderade villkoren',
		modificationDisclaimer:
			'Det är ditt ansvar att regelbundet kontrollera denna sida för eventuella ändringar av användarvillkoren',
		...
		privacyIntro:
			'Din integritet är viktig för oss. Denna policy förklarar hur vi hanterar dina uppgifter.',
		informationCollected: 'Information Vi Samlar In',
		informationCollectedText:
			'Vi samlar in personuppgifter när du registrerar dig för våra evenemang eller använder vår webbplats:',
		...
		paymentInfoText:
			'Kortdetaljer när du gör ett köp (behandlas säkert av vår betalningsleverantör)',
		usageItems: 'Hur Vi Använder Din Information',
		howWeUseInfo:
			'Vi använder din information på olika sätt för att tillhandahålla och förbättra våra tjänster:',
		contactCard: 'Kontakt och kommunikation',
		contactCardText:
			'För att kommunicera med dig om evenemanget, din registrering och viktiga uppdateringar',
		improvementsCard: 'Tjänsteförbättringar',
		improvementsCardText:
			'För att analysera användningsmönster och förbättra vår webbplats och tjänster',
		...
		dataRetentionPolicyText:
			'Vi behåller endast dina personuppgifter så länge som det är nödvändigt för att uppfylla de syften för vilka de samlades in.',
		...
		yourRightsText:
			'Enligt dataskyddslagarna har du rättigheter relaterade till dina personuppgifter:',
		...
		rightsNoteText:
			'Du behöver inte betala någon avgift för att få tillgång till dina personuppgifter. Vi kan dock ta ut en rimlig avgift om din begäran är uppenbart ogrundad, repetitiv eller överdriven.',
		...
		privacyContactText:
			'Om du har några frågor om denna integritetspolicy eller våra integritetsprinciper, vänligen kontakta oss på:',
		...
		svDataRetentionText:
			'Vi behåller dina personuppgifter endast så länge som det är nödvändigt för de ändamål för vilka de samlades in.',
		...
		introText:
			'Upplev Sveriges främsta löparevenemang – där Sandvikens rika industriella hjärta möter den vilda andan i Gästriklands skogar och sjöar.',
		inauguralEventTitle: 'FÖRSTA EVENEMANGET • 2026',
		bePartOfHistory: 'Var med i <span class="text-red-600">löphistoria</span>',
		inauguralDescription:
			'Sandviken Marathon är inte bara ett lopp – det är en milstolpe för vår stad och Sveriges löpargemenskap. Följ med oss när vi smider en ny tradition på en plats känd för innovation och uthållighet, och etablerar ett prestigefyllt skandinaviskt löparevenemang.',
		...
		eventRulesText:
			'Detaljerade regler och bestämmelser kommer att tillhandahållas närmare evenemangsdatumet.',
		volunteerSection: 'Volontärinformation',
		volunteerText:
			'Intresserad av att vara volontär? Vi behöver hjälp med olika uppgifter. Anmäl dig via kontaktformuläret.',
		riskManagementTitle: 'Riskhantering och Säkerhet',
		riskManagementDesc:
			'Risk: Oväntade väderförhållanden, Hälsoproblem hos deltagare, Trafiksäkerhet, Logistik och organisation, Säkerhet och säkerhetsåtgärder. Åtgärd: Beredskapsplan för väder, medicinsk personal och första hjälpen, korrekt avspärrad bana med trafikvakter, detaljerad logistikplan, samarbete med myndigheter och säkerhetsföretag.',
		staffingPlanTitle: 'Evenemangspersonal och Support',
		staffingPlanDesc:
			'Funktionärer kommer att finnas på plats för att hjälpa till med deltagarregistrering, utdelning av nummerlappar och startpaket, ge vägledning och information, övervaka banan, hantera vätskestationer samt assistera vid start- och målområden. Medicinsk personal kommer att finnas tillgänglig under hela evenemanget för att ge första hjälpen, övervaka hälsa, hantera nödsituationer och kommer att vara strategiskt placerade längs banan samt vid start- och målområden under evenemangets tider. Ordningsvakter kommer att säkerställa säkerhet och ordning, övervaka åskådarområden, hantera säkerhetsincidenter och se till att banan är korrekt avspärrad.',
		stadsparkenMapAlt:
			'Karta över Stadsparken som visar viktiga områden för Sandviken Marathon, inklusive start/mål, expo och bekvämligheter.',

		// Cookie Consent
		cookieNoticeText:
			'Denna webbplats använder <a href="/privacy#cookies" class="underline hover:text-red-600">cookies</a> för att säkerställa att du får den bästa upplevelsen. Genom att fortsätta surfa godkänner du vår användning av cookies.'
	}
};
