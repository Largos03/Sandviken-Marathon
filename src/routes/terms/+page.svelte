<script lang="ts">
	...
	import { SidebarNav, ContactSection, TabHandler, HeroSection, ContentCard, InfoCard, TabsNav } from '$lib';
...
<svelte:head>
	<title>{t('terms')} | Sandviken Half-marathon</title>
	<meta name="description" content={t('termsIntro')} />
	<meta name="robots" content="noindex,follow" />
	<link rel="canonical" href="https://sandvikenhalfmarathon.com/terms" />
</svelte:head>
